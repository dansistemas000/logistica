    ...
    <div class="d-flex justify-content-center h-100">
        <div class="card">
            <div class="card-header">
                <h3><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Alta usuario empleado</h3>
            </div>
            <div class="card-body">
                <div class="result"></div>
                <form class="form_register form" action="add_employed">
                    <input type="hidden" value="3" name="profile_id">
                     <input type="hidden" value="{{ $id }}" name="company_id">
                     <input type="hidden" value="1" name="free_pay">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 input-container">
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control validate-text" name="company" placeholder="NOMBRE EMPRESA" required="required" value="{{ $company }}" readonly="readonly">
